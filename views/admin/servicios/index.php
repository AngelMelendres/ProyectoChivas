        ...
        <div class="col-9 bg-light">
            ...
            <section class="d-flex m-4 mt-3 p-3">
                <div class="col d-flex">
                    <a href="<?php echo constant('URL') ?>admin/servicios/registrar"> <button class="btn btn-success"> + NUEVO</button>
                    </a>
                    ...
                    <tbody>
                        <?php foreach ($this->servicios as $servicio) { ?>
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo constant('URL') ?>public/img/<?php echo $servicio->imagen ?>" width="100px">

                                </td>
                                <td><?php echo $servicio->costo ?> $</td>
                                <td><?php echo $servicio->telefono ?></td>
                                <td class="">
                                    <button class="btn btn-primary"><a href="<?php echo constant('URL') ?>admin/servicios/ver?id=<?php echo $servicio->id ?>" class="text-white fa-solid fa-eye"></a></button>
                                    <button class="btn btn-dark"><a href="<?php echo constant('URL') ?>admin/servicios/editar?id=<?php echo $servicio->id ?>" class=" text-white fa-solid fa-pen-to-square"></a></button>
                                    <button class="btn btn-danger"><a href="<?php echo constant('URL') ?>admin/servicios/eliminar?id=<?php echo $servicio->id ?>" class="text-white fa-solid fa-trash"></a></button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
