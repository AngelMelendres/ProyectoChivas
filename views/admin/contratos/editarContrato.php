    ...
    <div class="vh-100 d-flex">
        ...
        <div class="col-9 bg-light">
            ...
            <section class="card m-3 p-3">
                <h4>Edicion Contratacion de un servicio</h4>
                <hr>

                <form method="POST" action="<?php echo constant('URL') ?>admin/contratos/update?idCliente=<?php echo $this->contrato->idCliente?>&id=<?php echo $this->contrato->id?>" enctype="multipart/form-data" id="formRegistroServicio">
                    <div class="p-3 d-flex justify-content-between">
                        <div class="col mx-1">
                            <label>Fecha</label>
                            <input value="<?php echo $this->contrato->fecha ?>" required name="fecha" id="fecha" type="date" class="form-control" value="2022-07-19"  min="2022-07-19" max="2023-05-15">
                        </div>
                        <div class="col mx-1">
                            <label>Codigo</label>
                            <input value="<?php echo $this->contrato->codigo?>" name="codigo" id="codigo" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="p-3 d-flex justify-content-between">
                        ...
                        <div class="col mx-1">
                            <h3>Chivas</h3>
                            <select required class="form-control" name="idServicio" id="servicio">
                                <option disabled selected value="<?php echo $this->contrato->idChiva ?>">--Selecione un servicio--</option>
